...
class TestWorkerFactory @Inject constructor(
    ...
    override fun createWorker(
        ...
        return when (workerClassName) {
            TestRefreshDataWorker::class.qualifiedName -> {
                val childWorkerFactory = workerProviders[TestRefreshDataWorker::class.java]?.get()
